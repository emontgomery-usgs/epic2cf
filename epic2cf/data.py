...
epic_map = {
    ...
    300  : dict(standard_name='sea_water_speed', long_name='Current speed', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods=None),  # CS :CURRENT SPEED (CM/S)      :vspd:cm s-1:f8.2:oceanographic (going to),
    ...
    412  : dict(standard_name='wind_from_direction', long_name='Wind Direction (from TN)', units='degree', convert=lambda x: x, cf_units='degree', cell_methods=None),  # WD :Wind Direction (from)    : :degrees_T:F6.2:Wind Direction (from),
    ...
    1204 : dict(standard_name='upward_sea_water_velocity', long_name='Upward (w) velocity', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods=None),  # w   :Vertical Velocity        :w:cm/s: :Vertical Velocity,  LOOK: Is this 'upwards' positive?  I'm assuming so...
    1205 : dict(standard_name='eastward_sea_water_velocity', long_name='Eastward (u) velocity', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods=None),  # u   :Eastward Velocity        :u:cm/s: :Eastward Velocity,
    1206 : dict(standard_name='northward_sea_water_velocity', long_name='Northward (v) velocity', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods=None),  # v   :Northward Velocity       :v:cm/s: :Northward Velocity,
    ...
    4007 : dict(standard_name='sea_water_speed', long_name='Current speed', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods=None),  # vspd:VECTOR SPEED            :vspd:cm s-1:f8.2:vector speed from U and V,
    ...
    4060 : dict(standard_name='sea_surface_wave_mean_period_from_variance_spectral_density_second_frequency_moment', long_name='Average Wave Period', units='s', convert=lambda x: x, cf_units='s', cell_methods=None),  # wp  :average wave period       :wave_period:s:f10.2:,  LOOK: This is not really a CF name.
    ...
    4064 : dict(standard_name='sea_surface_wave_maximum_height', long_name='maximum wave height', units='m', convert=lambda x: x, cf_units=None, cell_methods=None),  # mwh :Maximum Wave Height      :wave_height:m:f10.2:,
    ...
    4097 : dict(standard_name='upward_sea_water_velocity', long_name='Upward (w) velocity', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods='time: standard_deviation'),  # USTD:STD Eastward velocity     :ustd:cm s-1:f8.2:standard deviation of east component,
    4098 : dict(standard_name='northward_sea_water_velocity', long_name='Northard (w) velocity', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods='time: standard_deviation'),  # VSTD:STD Northward velocity    :vstd:cm s-1:f8.2:standard deviation of north component,
    4099 : dict(standard_name='upward_sea_water_velocity', long_name='Upward (w) velocity', units='cm/s', convert=lambda x: x/100., cf_units='m/s', cell_methods='time: standard_deviation'),  # WSTD:STD Vertical velocity     :wstd:cm s-1:f8.2:standard deviation of upward component,
